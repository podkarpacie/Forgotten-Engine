...
| Lifecycle delivery | Condition visual effects, condition-driven death activation, death screens, automatic respawn packets, default loss formula, and persistence of runtime condition tick progress remain deferred. |
