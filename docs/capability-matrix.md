...
| Typed skill progression, experience and vocation rules | partial — typed seven-skill levels/percentages and numeric vocation identity are authoritative, SQLite-persisted, locally provisionable, and delivered in classic 740 bootstrap/refresh records; operator-owned TFS-style `data/XML/vocations.xml` is boundedly parsed/audited and supplies profile-gated online health/mana regeneration, plus hydrated bounded poison/burning/energy damage scheduling, to the native 740 path with persisted vitals; condition effect packets, condition-driven death activation, runtime condition-tick persistence, soul, death/respawn, skill tries/formulas, promotion runtime, and TFS-compatible experience calculation remain deferred | deferred | deferred |
