...
existing profile-neutral physical flat reduction for a typed declarative weapon event and for the
existing opt-in fixed static-creature physical attack before it evaluates a lethal transition.
