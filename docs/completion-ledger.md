...
- [x] Route a native player’s existing bounded selected-static melee transition through an immediate parser-shaped 740 creature-health record and persisted static runtime snapshot; defeated static creatures use the established visibility refresh, while loot, corpses, formulas, rewards, scripts, AI, and real-client confirmation remain deferred.
