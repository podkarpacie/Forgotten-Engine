...
/// deliberately bounded to the client-visible 0â€“100 range; skill tries and advancement formulas
...
impl WorldState {
    ...
    /// Records one side's acceptance. Returns true only when both sides have now accepted â€”
    ...
    /// (equipmentâ†”container, containerâ†”container, stacks, swaps) resolves to a
