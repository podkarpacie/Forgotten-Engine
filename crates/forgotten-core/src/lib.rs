...
/// deliberately bounded to the client-visible 0Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ä‚ËĂ˘â€šÂ¬Äąâ€ş100 range; skill tries and advancement formulas
...
impl WorldState {
    ...
    /// (equipmentĂ„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬Ă‚Â Ä‚ËĂ˘â€šÂ¬ÄąÄ„container, containerĂ„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬Ă‚Â Ä‚ËĂ˘â€šÂ¬ÄąÄ„container, stacks, swaps) resolves to a
