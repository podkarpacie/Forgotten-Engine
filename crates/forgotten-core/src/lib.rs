...
/// deliberately bounded to the client-visible 0Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬Ĺ›100 range; skill tries and advancement formulas
...
impl WorldState {
    ...
    /// (equipmentÄ‚ËĂ˘â‚¬Â Ă˘â‚¬ĹĄcontainer, containerÄ‚ËĂ˘â‚¬Â Ă˘â‚¬ĹĄcontainer, stacks, swaps) resolves to a
