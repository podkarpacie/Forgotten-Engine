...
/// deliberately bounded to the client-visible 0Ă˘â‚¬â€ś100 range; skill tries and advancement formulas
...
impl WorldState {
    ...
    /// (equipmentĂ˘â€ â€ťcontainer, containerĂ˘â€ â€ťcontainer, stacks, swaps) resolves to a
