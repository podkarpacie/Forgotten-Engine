...
- [ ] Add bounded typed skill-try and magic-mana counters plus explicit multiplier-driven advancement rules derived from the validated vocation registry; weapon/spell gain events and profile-specific parity validation remain deferred.
